...
def CreateModelAndLearn(net_arch_enabled, net_arch, algorithm, maxsteps, pbenchmark, observataionSpace, stepvalue):
    ...
    while timestep_count <= maxsteps:
        ...
        if (timestep_count == maxsteps):
            Model_Path = os.path.join('Training','Saved_Models_Algo_Comp_512_InstCount_cbench_bzip',algorithm+'_Model_algoComp_steps_'+str(timestep_count))
...
FinalFileWriteWithCreateMpdelAndLearn(False, 0, 'PPO', 30000,"cbench-v1/bzip2","InstCount",1000)

        ...
        if (layernodes > 0):
            if (tuned):
                ...
                model = PPO('MlpPolicy', wrapped_env_normal, verbose=1, policy_kwargs={"net_arch": net_arch},
                    learning_rate= 0.00018, gae_lambda= 0.87828,gamma= 0.94052,n_steps= 640)
            else:
...
FinalFileWriteWithCreateMpdelAndLearn('PPO_25000_bzip2__instcount_PLAIN_HYPER', 'PPO', 25000,"cbench-v1/bzip2","InstCount",1000,0,True)
